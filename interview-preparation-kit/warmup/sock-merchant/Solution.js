...
function sockMerchant(n, ar) {
    return [...new Set(ar)].reduce((pairs, color) => {
        //console.log(pairs, color);
        const colorLength = ar.filter(socket => socket === color).length;
        return pairs + (colorLength - colorLength % 2) / 2;
    }, 0);
}
